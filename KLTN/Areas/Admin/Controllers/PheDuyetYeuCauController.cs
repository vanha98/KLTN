...
namespace KLTN.Areas.Admin.Controllers
{
    ...
    public class PheDuyetYeuCauController : Controller
    {
        ...
        //        // getting all Customer data  
        //        var entity = await _serviceDeTai.GetAll(x=>x.TinhTrangDeTai == (int)StatusDeTai.DaDuyet);
        //        //foreach(var item in entity)
        //        //{
        //        //    string name = item.IdgiangVienNavigation.Ho +" "+ item.IdgiangVienNavigation.Ten;
        //        //}
        ...
        public async Task<IActionResult> ChangeStatus (long idDeTai, int type)
        {
            ...
            if (type == 1) //approve
            {
                ...
                yeuCau.IddeTaiNghienCuuNavigation.TinhTrangPheDuyet = (int)StatusPheDuyet.ChuaCoYeuCau;
                yeuCau.IddeTaiNghienCuuNavigation.TinhTrangDeTai = (int)StatusDeTai.DaDuyet;

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenTepCauHoi = table.Column<string>(nullable: true),
                    TepDinhKemCauHoi = table.Column<string>(nullable: true),
                    CauTraLoi = table.Column<string>(nullable: true),
                    TenTepCauTraLoi = table.Column<string>(nullable: true),
                    TepDinhKemCauTraLoi = table.Column<string>(nullable: true),
